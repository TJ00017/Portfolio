...
[Your Name]`;
  ...
  const bgImageUrl = './bg.jpg'; // Replace with your actual image URL
  const bgStyle = {
    backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.836), rgba(0,0,0,0.811)), url(${bgImageUrl})`,
  ...
  return (
    <section id="Home">
      <div className='w-[100vw] pt-[4vh] md:pt-[12vh] h-[85vh] md:h-[100vh]' style={bgStyle}>
